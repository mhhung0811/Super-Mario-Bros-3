...
#define ID_SPRITE_GROUND_TOP_BEGIN (ID_SPRITE_GROUND_TOP + 1000)
#define ID_SPRITE_GROUND_TOP_MIDDLE (ID_SPRITE_GROUND_TOP + 2000)
#define ID_SPRITE_GROUND_TOP_END (ID_SPRITE_GROUND_TOP + 3000)

#define ID_SPRITE_GROUND_MID 70000
#define ID_SPRITE_GROUND_MID_BEGIN (ID_SPRITE_GROUND_MID + 1000)
#define ID_SPRITE_GROUND_MID_MIDDLE (ID_SPRITE_GROUND_MID + 2000)
#define ID_SPRITE_GROUND_MID_END (ID_SPRITE_GROUND_MID + 3000)